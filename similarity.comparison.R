##bacteria
library(dplyr)
bacteria.normal <- read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/forth/pooled and unpooled comparison/diversity original_not summarize/bacteria.rarefy.table.csv",header = TRUE,sep = ",",row.names = 1)
bacteria.normal<-bacteria.normal[,!grepl("DNA|soil",names(bacteria.normal))]
metadata.normal<-read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/normal_metadata.csv",header = TRUE,sep = ",")
...
##animal
animal.normal <- read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/forth/pooled and unpooled comparison/diversity original_not summarize/animal.rarefy.table2.csv",header = TRUE,sep = ",",row.names = 1)
...
##fungi
fungi.normal <- read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/forth/pooled and unpooled comparison/diversity original_not summarize/fungi.rarefy.table2.csv",header = TRUE,sep = ",",row.names = 1)
...
###for pool
setwd("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/forth/pooled and unpooled comparison/17.pool similarity")
##bacteria
library(dplyr)
#DNA
...
metadata.DNA<-read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/soil.metadata.csv",header = TRUE,sep = ",")
...
metadata.soil<-read.csv("C:/Users/meirong/Desktop/PhD project/downstream/richness and shannon/soil.metadata.csv",header = TRUE,sep = ",")
